...
This writes deterministic sample signals and a local branch fixture to
`.evofork/demo-seed.json`. The file is local run state and is ignored by git.
...
该命令会把确定性的示例 signals 和本地 branch fixture 写入
